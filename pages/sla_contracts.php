...
// ── Dummy Data ──
$contracts = [
    ['id'=>'SLA-001','client'=>'Acme Corp',    'plan'=>'Enterprise',    'start'=>'2026-01-01','end'=>'2026-12-31','response_sla'=>'1 hour',  'visits'=>'Unlimited','status'=>'active'],
    ['id'=>'SLA-002','client'=>'Globe BPO',    'plan'=>'Professional',  'start'=>'2026-02-01','end'=>'2027-01-31','response_sla'=>'4 hours', 'visits'=>'6 / year', 'status'=>'active'],
    ['id'=>'SLA-003','client'=>'BPI Office',   'plan'=>'Basic',         'start'=>'2026-03-01','end'=>'2027-02-28','response_sla'=>'8 hours', 'visits'=>'2 / year', 'status'=>'active'],
    ['id'=>'SLA-004','client'=>'SM Supermall', 'plan'=>'Professional',  'start'=>'2025-07-01','end'=>'2026-06-30','response_sla'=>'4 hours', 'visits'=>'6 / year', 'status'=>'expiring'],
    ['id'=>'SLA-005','client'=>'Robinsons',    'plan'=>'Basic',         'start'=>'2025-04-01','end'=>'2026-03-31','response_sla'=>'8 hours', 'visits'=>'2 / year', 'status'=>'expired'],
];
        ...
        <table class="ts-table">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td style="font-size:.875rem;color:var(--text-muted);"><?php echo $c['visits']; ?></td>
